...
Samanage.prototype.MessageTemplate    = require(__dirname + '/lib/MessageTemplate.js'      );
Samanage.prototype.categories         = require(__dirname + '/lib/categories.js'           );
Samanage.prototype.changes            = require(__dirname + '/lib/changes.js'              );
Samanage.prototype.comments           = require(__dirname + '/lib/comments.js'             );
Samanage.prototype.configurationItems = require(__dirname + '/lib/configurationItems.js'   );
Samanage.prototype.contracts          = require(__dirname + '/lib/contracts.js'            );
Samanage.prototype.departments        = require(__dirname + '/lib/departments.js'          );
Samanage.prototype.groups             = require(__dirname + '/lib/groups.js'               );
Samanage.prototype.hardware           = require(__dirname + '/lib/hardware.js'             );
Samanage.prototype.incidents          = require(__dirname + '/lib/incidents.js'            );
Samanage.prototype.items              = require(__dirname + '/lib/items.js'                );
Samanage.prototype.memberships        = require(__dirname + '/lib/memberships.js'          );
Samanage.prototype.mobileDevices      = require(__dirname + '/lib/mobileDevices.js'        );
Samanage.prototype.otherAssets        = require(__dirname + '/lib/otherAssets.js'          );
Samanage.prototype.printers           = require(__dirname + '/lib/printers.js'             );
Samanage.prototype.problems           = require(__dirname + '/lib/problems.js'             );
Samanage.prototype.purchases          = require(__dirname + '/lib/purchases.js'            );
Samanage.prototype.purchaseOrders     = require(__dirname + '/lib/purchaseOrders.js'       );
Samanage.prototype.releases           = require(__dirname + '/lib/releases.js'             );
Samanage.prototype.risks              = require(__dirname + '/lib/risks.js'                );
Samanage.prototype.roles              = require(__dirname + '/lib/roles.js'                );
Samanage.prototype.serviceRequests    = require(__dirname + '/lib/serviceRequests.js'      );
Samanage.prototype.sites              = require(__dirname + '/lib/sites.js'                );
Samanage.prototype.software           = require(__dirname + '/lib/software.js'             );
Samanage.prototype.solutions          = require(__dirname + '/lib/solutions.js'            );
Samanage.prototype.tasks              = require(__dirname + '/lib/tasks.js'                );
Samanage.prototype.timeTracks         = require(__dirname + '/lib/timeTracks.js'           );
Samanage.prototype.users              = require(__dirname + '/lib/users.js'                );
Samanage.prototype.vendors            = require(__dirname + '/lib/vendors.js'              );
