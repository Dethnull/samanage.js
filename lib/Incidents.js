...
let incidents = function (options, auth) {
     ...
     * does for you.
     *
     * @param {IncidentTemplate} incidentTemplate This should be passed an object created from IncidentTemplate.
     ...
     * @param {number} attempt The current attempt number. Used only when a 503 status code was found, Note you shouldn't set this yourself, the method will pass the correct value in its place
     * @param {number} waitTime The amount of time to wait until the request is attempted again
     * @returns {Promise}
     */
    let create = function (incidentTemplate, retry, waitTime, attempt) {
